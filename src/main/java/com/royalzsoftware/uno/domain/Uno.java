...
import com.royalzsoftware.uno.domain.cards.ActionCard;
...
import com.royalzsoftware.uno.domain.events.GameStartedEvent;
import com.royalzsoftware.uno.domain.events.PlayerJoinedEvent;
import com.royalzsoftware.uno.domain.events.TurnChangedEvent;
import com.royalzsoftware.uno.domain.exceptions.InvalidMoveException;
import com.royalzsoftware.uno.domain.exceptions.NotYourTurnException;
...
public class Uno {
    ...
    private void publishForAllParticipants(Event event) {
        this.subscribers.forEach(t -> t.eventReceived(event));
    }
